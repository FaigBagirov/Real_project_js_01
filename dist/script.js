...
/* harmony import */ var _modules_gatherFormData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/gatherFormData */ "./src/js/modules/gatherFormData.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(); //call modal windows handler only when all document content was loaded

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', 'glazing_block', 'glazing_content', 'active'); //'classname > otherClassName' means get direct child of "className"

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', 'no_click', 'decoration_content > div > div', 'after_click'); //for tabSelector I can use  either balcon_icons_img or added by me calc_tab

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', 'balcon_icons_img', 'big_img > img', 'do_image_more', 'inline-block');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(formDataCollctn);
  Object(_modules_gatherFormData__WEBPACK_IMPORTED_MODULE_4__["default"])(formDataCollctn);
});

/***/ }),

/***/ "./src/js/modules/checkInputValues.js":
/*!********************************************!*\
  !*** ./src/js/modules/checkInputValues.js ***!
  \********************************************/
...
var checkInputValues = function checkInputValues(inputField, valuesType) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkInputValues);
...
/* harmony import */ var _checkInputValues__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkInputValues */ "./src/js/modules/checkInputValues.js");
...
var forms = function forms() {
  ...
  allInputs = document.querySelectorAll('input'); // allPhoneNumInputs = document.querySelectorAll('input[name="user_phone"]');
  ...
  Object(_checkInputValues__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]', "phone_nums");
  var messages = {
    loading: "is loading...",
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log("loading"); //without await "result" will be empty bcause it will not wait for async request

              _context.next = 5;
              return fetch(url, {
                //fetch() method is async method
                method: "POST",
                body: data //,
                // headers: headers
  ...
  allForms.forEach(function (eachForm) {
    eachForm.addEventListener('submit', function (event) {
      ...
      event.preventDefault(); //prepare html element for status message

      var statusMessage = document.createElement('div'); // prosto chtobi bilo krasivee
      //class "status" already exsists, designer created it before us

      statusMessage.classList.add('status'); //add created element message to the html

      eachForm.appendChild(statusMessage);
      var formData = new FormData(eachForm); // console.log("passing formdata to postData func");
...
/***/ "./src/js/modules/gatherFormData.js":
/*!******************************************!*\
  !*** ./src/js/modules/gatherFormData.js ***!
  \******************************************/
/*! exports provided: resetDataCollection, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetDataCollection", function() { return resetDataCollection; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _checkInputValues__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkInputValues */ "./src/js/modules/checkInputValues.js");



var gatherFormData = function gatherFormData(collctn) {
  var productForm = document.querySelectorAll('.balcon_icons_img'),
  ...
  Object(_checkInputValues__WEBPACK_IMPORTED_MODULE_1__["default"])('#width', "pure_nums");
  Object(_checkInputValues__WEBPACK_IMPORTED_MODULE_1__["default"])('#height', "pure_nums"); //console.log(productWidth);
        ...
        switch (item.nodeName) {
          ...
          case "INPUT":
            ...
            if (item.getAttribute('type') === 'checkbox') {
              var checkedProductType = item.nextElementSibling;
              ...
              element.forEach(function (checkBox) {
                var productType = checkBox.nextElementSibling;
                ...
                //the other inputs are text fields for width and height
...
var resetDataCollection = function resetDataCollection() {
  ...
  collctn[type] = undefined; // collctn = {
  //         form: undefined,
  //         width: undefined,
  //         hegth:undefined,
  //         type:undefined
...
/* harmony default export */ __webpack_exports__["default"] = (gatherFormData);
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var closeOnOutsideClick = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    //varibles for universal modal window handler
    var trigger = document.querySelectorAll(triggerSelector),
        //array of buttons that trigger each modal window
    modal = document.querySelector(modalSelector),
        //modal window itself
    close = document.querySelector(closeSelector),
        // close button on each modal windows
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (event) {
        ...
        modal.style.display = "block"; // document.body.classList.add('modal-open'); //modal-open is bootstrap predefined class
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTab(clickedTab) {
    ...
    if (clickedTab === undefined) {
      ...
      console.log(document.querySelector("#".concat(clickedTab.dataset.slide)));
      document.querySelector("#".concat(clickedTab.dataset.slide)).style.display = display;
  ...
  hideAllTabs();
  showTab(); //add click listener for whole header of the tabs

  header.addEventListener('click', function (event) {
    //if I plan to change "target" variable it must not be "const"
    var target = event.target; //checking if target of the click has the class of the tabs, which is passed as tabSelector
